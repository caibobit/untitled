...
im = g.imread('C:/Users/caibo/Desktop/buff.jpg')  # 改为你自己要测试的图片路径
im = im / 255.
# im=tf.reshape(im, [1,1200,1600,3])

im = im.reshape(1, 639, 1024, 3)
...
x = tf.placeholder(tf.float32, [None, 639, 1024, 3])
x = tf.cast(batch, 'float32')
print('begin---')
with tf.variable_scope('spatial_transformer_0'):
    n_fc = 6
    w_fc1 = tf.Variable(tf.Variable(tf.zeros([639 * 1024 * 3, n_fc]), name='W_fc1'))
    ...
    h_fc1 = tf.matmul(tf.zeros([num_batch, 639 * 1024 * 3]), w_fc1) + b_fc1
